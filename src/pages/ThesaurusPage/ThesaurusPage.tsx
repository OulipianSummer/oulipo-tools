import { IonButtons, IonContent, IonHeader, IonItem, IonMenuButton, IonPage, IonTitle, IonToolbar, IonText, IonList, IonInput, IonLabel, IonButton, IonChip, IonSelect } from '@ionic/react';
import './ThesaurusPage.css';
import { useState, useRef } from 'react';
import getThesaurusEntry from '../../word_apis/thesaurus';
import LetterFilter from '../../components/LetterFilter';
import HelpAlert from '../../components/HelpModal';

const ThesaurusPage: React.FC = () => {

  const name = 'Lipogram Thesarurus';
  ...
  const handleFilter = (input: Array<string>) => {
    setFilters(input);
  }
      ...
      <IonHeader>
        <IonToolbar>
          ...
          <HelpAlert 
            ...
            subHeader="A standard English Thesaurus, with a twist." 
            message="Use the Exclude Letters filter to only highlight results that do not contain any of the letters you selected."
          />
        </IonToolbar>
      </IonHeader>
